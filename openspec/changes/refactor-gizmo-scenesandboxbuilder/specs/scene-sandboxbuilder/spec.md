# Scene Sandbox Builder - Spec Delta

## MODIFIED Requirements

### Requirement: SceneSandboxBuilder manages gizmo rendering
**Previous**: SceneSandboxBuilder contains all gizmo rendering logic inline (~570 lines)

**New**: SceneSandboxBuilder delegates gizmo rendering to SandboxGizmoRenderer component
...
**Previous**: SceneSandboxBuilder has wrapper properties that forward to subsystems (CurrentScene, IsPlacementActive, etc.)

**New**: SceneSandboxBuilder exposes subsystems directly or removes redundant wrappers
