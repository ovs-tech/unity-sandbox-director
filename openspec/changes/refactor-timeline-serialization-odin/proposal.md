...
## Success Criteria
- [ ] Projects save and load with Odin serialization without data loss
- [ ] TrackFactory fully removed; unified `ProjectSerializer` API in place
- [ ] All track types (Anim, Morph, Movement, Signal, etc.) serialize correctly
- [ ] Unit tests pass for serialization round-trip
- [ ] Performance is equal or better than current implementation
- [ ] Documentation updated with new serialization approach
