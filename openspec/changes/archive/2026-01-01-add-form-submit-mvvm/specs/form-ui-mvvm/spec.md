...
This specification defines the MVVM (Model-View-ViewModel-Controller) architecture for the FormSubmit UI system. It establishes a clear separation of concerns between data (Model), presentation logic (ViewModel), UI representation (View), and orchestration (Controller).
...
1. **File Locations**:
   - `Assets/Scripts/Core/UI/FormSubmit/MVVM/FormSubmitModel.cs`
   - `Assets/Scripts/Core/UI/FormSubmit/MVVM/FormSubmitViewModel.cs`
   - `Assets/Scripts/Core/UI/FormSubmit/MVVM/FormSubmitView.cs`
   - `Assets/Scripts/Core/UI/FormSubmit/MVVM/FormSubmitController.cs`

2. **Dependencies**:
   - `Core.Helpers.BindableProperty<T>` (existing)
   - `Core.UI.FormSubmit.Fields.IFormFieldUIToolkit` (existing)
   - Unity UI Toolkit data binding system

3. **Testing**:
   - Unit tests: `Tests/Editor/Core/UI/FormSubmit/MVVM/`
   - Integration tests: `Tests/PlayMode/Core/UI/FormSubmit/MVVM/`

4. **Documentation**:
   - README: `Assets/Scripts/Core/UI/FormSubmit/MVVM/README.md`
   - Usage example: `Assets/Scripts/Core/UI/FormSubmit/MVVM/Examples/FormSubmitMVVMExample.cs`

---

## Related Capabilities

- **Timeline MVVM** (`timeline-ui-mvvm`): Established MVVM pattern for the project
- **Inventory MVVM**: Original MVVM reference implementation
- **Form Field Types** (`form-field-types`): Existing field type system that this capability integrates with
...
|---------|------|--------|---------|
| 1.0.0 | 2025-12-26 | AI Assistant | Initial specification |
