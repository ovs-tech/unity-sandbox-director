...
namespace SceneSandbox.Editor
{
    ...
    /// <summary>
    /// Menu items for SceneSandboxBuilder
    /// </summary>
    public static class SceneSandboxBuilderMenu
    {
        [MenuItem("Ero Director/Scene Sandbox/Create Scene Sandbox Builder")]
        public static void CreateSceneSandboxBuilder()
        {
            GameObject go = new GameObject("Scene Sandbox Builder");
            go.AddComponent<SceneSandboxBuilder>();
        ...
        [MenuItem("Ero Director/Scene Sandbox/Select Scene Sandbox Builder")]
        public static void SelectSceneSandboxBuilder()
        {
            var builder = Object.FindFirstObjectByType<SceneSandboxBuilder>();
            if (builder != null)
            {
            ...
            {
                EditorUtility.DisplayDialog("Scene Sandbox Builder", 
                    "No Scene Sandbox Builder found in the current scene. Create one first.", "OK");
            }
        }
        
        [MenuItem("Ero Director/Scene Sandbox/Create Object Library")]
        public static void CreateObjectLibrary()
        {
            string path = EditorUtility.SaveFilePanelInProject(
                "Create Scene Object Library",
                "NewObjectLibrary",
                "asset",
                "Choose where to save the Scene Object Library"
            );
