...
namespace MiniTimeline.Core
{
    ...
    public class BindingContext
    {
        ...
        {
            return UnityEngine.Object.FindObjectsByType<BindableObject>(FindObjectsSortMode.None);
        }
        ...
        {
            var allBindables = UnityEngine.Object.FindObjectsByType<BindableObject>(FindObjectsSortMode.None);
