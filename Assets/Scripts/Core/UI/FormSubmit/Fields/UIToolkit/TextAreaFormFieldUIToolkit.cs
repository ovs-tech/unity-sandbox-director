...
{
    /// <summary>
    /// Multi-line text input form field for UI Toolkit
    /// </summary>
    public class TextAreaFormFieldUIToolkit : IFormFieldUIToolkit
    {
        ...
        public void Initialize(FormFieldDefinition definition, VisualElement element)
        {
            ...
            if (textField != null)
            {
                ...
                // Check if it should be readonly
                if (definition.options != null && definition.options.ContainsKey("readonly"))
                {
                    if (definition.options["readonly"] is bool isReadonly && isReadonly)
                    {
